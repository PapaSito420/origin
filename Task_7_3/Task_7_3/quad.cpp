...
quad::quad(const std::string& triangle_name, int sidea, int sideb, int sidec, int aA, int aB, int aC)
    :figureQ(triangle_name, sidea, sideb, sidec, aA, aB, aC), T_name(triangle_name), a(sidea), b(sideb), c(sidec), A(aA), B(aB), C(aC) {
}
